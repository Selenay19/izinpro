...
function getTemporaryCredentials(req, res) {
  res.json({ success: true, data: userService.getTemporaryCredentials(req.params.id) });
}

function remove(req, res) {
  userService.remove(req.user, req.params.id);
